...
if(isset($_POST['submit'])){
   $msg="Name:".$_POST['name']."\nEmail:".$_POST['email']."\nMobile:".$_POST['phone']."\nMessage:".$_POST['message'];
    $send=mail("info@allstateestimation.us","Contact Form", $msg);
            ...
            <div class="widget contact-info-sidebar">
               ...
               <ul class="list-info">
                  <li>
                     ...
                     <div class="info-text">+(447) 701-411301</div>
                  </li>
                  <li>
                     <div class="info-icon">
                        <span class="fa fa-envelope fa-lg"></span>
                     </div>
                     <div class="info-text">info@allstateestimation.us</div>
                  </li>
                  <li>
                     <div class="info-icon">
                        <span class="fa fa-map-marker fa-lg"></span>
                     </div>
                     <div class="info-text">304 Peel House London Rd.morden<br> Post code sm45bt</div>
                  </li>
               </ul>
            </div>
         </div>
